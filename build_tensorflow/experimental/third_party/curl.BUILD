...
cc_library(
    ...
    srcs = [
        ...
        "@tfx_experimental//tensorflow:ios": [
            "lib/vtls/darwinssl.c",
        ],
        "@tfx_experimental//tensorflow:windows": CURL_WIN_SRCS,
        "//conditions:default": [
            "lib/vtls/openssl.c",
        ],
    }),
    ...
    copts = select({
        "@tfx_experimental//tensorflow:windows": CURL_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DBUILDING_LIBCURL",
    ...
    includes = ["include"],
    linkopts = select({
        "@tfx_experimental//tensorflow:android": [
            "-pie",
        ],
        "@tfx_experimental//tensorflow:darwin": [
            "-Wl,-framework",
...
cc_binary(
    ...
    copts = select({
        "@tfx_experimental//tensorflow:windows": CURL_BIN_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DHAVE_CONFIG_H",
