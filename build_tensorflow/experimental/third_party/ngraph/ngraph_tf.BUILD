...
load(
    "@tfx_experimental//tensorflow:tensorflow.bzl",
    "tf_cc_test",
)
...
cc_library(
    ...
    deps = [
        ...
        "@ngraph//:ngraph_core",
        "@tfx_experimental//tensorflow/core:core_cpu_headers_lib",
        "@tfx_experimental//tensorflow/core:framework_headers_lib",
        "@tfx_experimental//tensorflow/core:protos_all_proto_text",
    ],
    alwayslink = 1,
)
...
tf_cc_test(
    ...
    deps = [
        ...
        "@tfx_experimental//tensorflow/cc:cc_ops",
        "@tfx_experimental//tensorflow/cc:client_session",
        "@tfx_experimental//tensorflow/core:tensorflow",
    ],
)
